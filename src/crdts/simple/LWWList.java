...
/**
 * List with the Last Writer Wins concurrency policy.
 *
 * @param <T> - type of the element to be stored within the list.
 */
public class LWWList<T> extends AbstractList<T> {
    ...
    /**
     * Inserts an element at the specified position in the list, applying the Last Writer Wins concurrency policy.
     *
