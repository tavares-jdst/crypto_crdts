...
public class LWWSetBenchmark {
    ...
    public LWWSetBenchmark(int opType) {
        op = opType;
    ...
    public void executeMergeLWW(Params[] common, Params firstStruct, Params secondStruct) {
        ...
        try {
            ...
            for (int i = 0; i < common.length; i++) {
                //TODO structs
                LWWSet<String> s1 = new LWWSet<>(), s2 = new LWWSet<>();
    ...
    private static List<Long> preFillWithData(LWWSet<String> set, List<String> input, int nrTimestamps) {
    ...
    public static void main(String[] args) {
        ...
        Params p, p1, p2;
        LWWSetBenchmark benchie = new LWWSetBenchmark(op);
