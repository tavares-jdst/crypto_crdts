...
public class OURMapBenchmark {
    ...
    public OURMapBenchmark(int opType) {
        op = opType;
    ...
    public void executeMergeOUR(Params[] common, Params firstStruct, Params secondStruct) {
        ...
        try {
            ...
            for (int i = 0; i < common.length; i++) {
                OURMap<String, String> map1 = new OURMap<>(), map2 = new OURMap<>();
    ...
    private static List<Long> preFillWithData(OURMap map, Map<String, String> input, int nrTimestamps) {
    ...
    public static void main(String[] args) {
        ...
        Params p, p1, p2;
        OURMapBenchmark benchie = new OURMapBenchmark(op);
