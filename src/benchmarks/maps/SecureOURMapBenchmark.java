...
public class SecureOURMapBenchmark {
    ...
    public SecureOURMapBenchmark(int opType) {
        op = opType;
    ...
    public static void executeOUR(Params p) {
        ...
        SecureOURMap map = new SecureOURMap();
        ...
        try {
            ...
            System.out.println(">>>>>>>>>>>>>>>>>> BENCHMARK STATS OUR MAP");
    ...
    public void executeMergeOUR(Params common[], Params firstStruct, Params secondStruct) {
        ...
        try {
            ...
            for (int i = 0; i < common.length; i++) {
                SecureOURMap map1 = new SecureOURMap(), map2 = new SecureOURMap();
    ...
    private static List<Long> preFillWithData(SecureOURMap map, Map<ComparableByteArray, ComparableByteArray> input, int nrTimestamps) {
    ...
    public static void main(String[] args) {
        ...
        Params p, p1, p2;
        SecureOURMapBenchmark benchie = new SecureOURMapBenchmark(op);
