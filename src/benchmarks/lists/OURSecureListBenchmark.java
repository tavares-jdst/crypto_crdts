...
public class OURSecureListBenchmark {
    ...
    public OURSecureListBenchmark(int opType) {
        op = opType;
    }
    ...
    public static void executeOUR(Params p) {
        ...
        SecureOURList list = new SecureOURList();
    ...
    public void executeMergeOUR(Params[] common, Params firstStruct, Params secondStruct) {
        ...
        try {
            ...
            for (int i = 0; i < common.length; i++) {
                //TODO structs
                SecureOURList l1 = new SecureOURList(), l2 = new SecureOURList();
    ...
    private static List<Long> preFillWithData(SecureOURList list, List<ComparableByteArray> input, int nrTimestamps) {
    ...
    public static void main(String[] args) {
        ...
        Params p, p1, p2;
        OURSecureListBenchmark benchie = new OURSecureListBenchmark(op);
