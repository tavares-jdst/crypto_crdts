...
public class OURListBenchmark {
    ...
    public OURListBenchmark(int opType) {
        op = opType;
    ...
    public void executeMergeOUR(Params[] common, Params firstStruct, Params secondStruct) {
        ...
        try {
            ...
            for (int i = 0; i < common.length; i++) {
                //TODO structs
                OURList<String> l1 = new OURList<>(), l2 = new OURList<>();
    ...
    private static List<Long> preFillWithData(OURList<String> list, List<String> input, int nrTimestamps) {
    ...
    public static void main(String[] args) {
        ...
        Params p, p1, p2;
        OURListBenchmark benchie = new OURListBenchmark(op);
